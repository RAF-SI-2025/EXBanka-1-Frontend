describe('Password Reset Page', () => {
  ...
  it('should submit new password successfully', () => {
    cy.intercept('POST', 'https://bytenity.com/api/auth/password/reset', { statusCode: 200, body: {} }).as(
      'resetPassword'
    )
  ...
  it('should show error message on API failure', () => {
    cy.intercept('POST', 'https://bytenity.com/api/auth/password/reset', { statusCode: 400, body: {} }).as(
      'resetPasswordFail'
    )
