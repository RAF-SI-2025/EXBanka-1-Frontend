describe('Celina 6: Kartice — Upravljanje bankarskim karticama', () => {
  describe('Client: Card Request & Viewing (Scenarios 28–30, 32)', () => {
    beforeEach(() => {
      cy.intercept('GET', 'https://bytenity.com/api/me/cards', { fixture: 'cards-list.json' }).as('getCards')
      cy.intercept('GET', 'https://bytenity.com/api/me', {
        body: {
          id: 42,
          first_name: 'Marko',
          last_name: 'Jovanović',
      ...
      cy.intercept('GET', 'https://bytenity.com/api/me/accounts', { fixture: 'accounts.json' }).as('getAccounts')
      cy.intercept('GET', 'https://bytenity.com/api/me/payments*', {
    ...
    it('should request a new card for a personal account (Scenario 28)', () => {
      cy.intercept('POST', 'https://bytenity.com/api/me/cards/requests', {
        statusCode: 201,
        body: {
          id: 5,
    ...
    it('should temporarily block an active card for 12 hours (Scenario 30)', () => {
      cy.intercept('POST', 'https://bytenity.com/api/me/cards/10/temporary-block', {
        statusCode: 200,
        body: {},
      }).as('blockCard')
      ...
      cy.intercept('GET', 'https://bytenity.com/api/me/cards', {
        body: {
          cards: [
            {
              id: 10,
  ...
  describe('Employee: Card Management (Scenarios 27, 31)', () => {
    ...
    it('should create a card automatically when account is created with card option (Scenario 27)', () => {
      cy.intercept('GET', 'https://bytenity.com/api/clients?*', { fixture: 'clients.json' }).as('searchClients')
      cy.intercept('POST', 'https://bytenity.com/api/accounts', {
        statusCode: 201,
        fixture: 'create-account-response.json',
      }).as('createAccount')
      cy.intercept('GET', 'https://bytenity.com/api/accounts?*', { fixture: 'accounts.json' }).as('getAccounts')
      cy.intercept('GET', 'https://bytenity.com/api/clients', { fixture: 'clients.json' }).as('getAllClients')
    ...
    it('should unblock a blocked card from admin panel (Scenario 31)', () => {
      cy.intercept('GET', 'https://bytenity.com/api/accounts/1', { fixture: 'admin-account.json' }).as('getAccount')
      cy.intercept('GET', 'https://bytenity.com/api/cards?account_number=265000000000000011', {
        fixture: 'admin-cards.json',
      }).as('getAccountCards')
      cy.intercept('POST', 'https://bytenity.com/api/cards/11/unblock', {
        statusCode: 200,
        body: {},
      }).as('unblockCard')
