describe('Admin Loans Page', () => {
  it('should display loans table with all columns', () => {
    cy.intercept('GET', 'https://bytenity.com/api/loans*', { fixture: 'admin-loans-list.json' }).as('getLoans')
  ...
  it('should show empty state when no loans', () => {
    cy.intercept('GET', 'https://bytenity.com/api/loans*', { body: { loans: [], total: 0 } }).as('getEmptyLoans')
