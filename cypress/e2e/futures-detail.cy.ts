describe('Futures Detail Page', () => {
  beforeEach(() => {
    cy.intercept('GET', 'https://bytenity.com/api/securities/futures/10', { fixture: 'future-detail.json' }).as(
      'getFuture'
    )
    cy.intercept('GET', 'https://bytenity.com/api/securities/futures/10/history*', {
  ...
  it('should show not found for invalid futures id', () => {
    cy.intercept('GET', 'https://bytenity.com/api/securities/futures/999', { statusCode: 200, body: null }).as(
      'getFutureNotFound'
    )
    cy.intercept('GET', 'https://bytenity.com/api/securities/futures/999/history*', {
