describe('Celina 7: Krediti — Upravljanje kreditima', () => {
  describe('Client: Loan Application & Viewing (Scenarios 33–34)', () => {
    ...
    it('should submit a loan application (Scenario 33)', () => {
      cy.intercept('POST', 'https://bytenity.com/api/me/loan-requests', {
        statusCode: 201,
    ...
    it('should display loan list with status badges (Scenario 34)', () => {
      cy.intercept('GET', 'https://bytenity.com/api/me/loans', { fixture: 'loans-list.json' }).as('getLoans')
  ...
  describe('Employee: Loan Request Management (Scenarios 35–36)', () => {
    beforeEach(() => {
      cy.intercept('GET', 'https://bytenity.com/api/loan-requests*', {
        fixture: 'loan-requests-pending.json',
      }).as('getLoanRequests')
      cy.intercept('GET', 'https://bytenity.com/api/clients*', {
        body: {
          clients: [
            {
              id: 42,
    ...
    it('should approve a pending loan request (Scenario 35)', () => {
      cy.intercept('POST', 'https://bytenity.com/api/loan-requests/10/approve', {
        statusCode: 200,
        body: {},
      }).as('approveRequest')
    ...
    it('should reject a pending loan request (Scenario 36)', () => {
      cy.intercept('POST', 'https://bytenity.com/api/loan-requests/10/reject', {
        statusCode: 200,
        body: {},
      }).as('rejectRequest')
